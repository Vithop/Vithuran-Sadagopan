...
const experiences = [
  ...
  },
  {
    ...
    location: "VANCOUVER, BC",
    description:
      "Modernized payment checkout architecture and high-throughput backend services handling massive transaction volumes, driving $300M in incremental annual revenue.",
    achievements: [
